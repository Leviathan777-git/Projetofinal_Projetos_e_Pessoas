...
create table Projeto_Prj(
	prj_codigo int primary key auto_increment,
    prj_tipo varchar(30),
    prj_descricao varchar(10),
    prj_iniciativa varchar(10),
    prj_dtinicio varchar(10),
    pes_codigo int,
    constraint fk_codigo foreign key (pes_codigo) references Pessoa_Pes(pes_codigo)
);

insert into Pessoa_Pes (pes_nome, pes_apelido, pes_sexo, pes_dtnascimento) 
values
	('Gabriel', 'gabs', 'M', '06-02-1999'),
	('Joao', 'jao', 'M', '24-07-1978'),
    ('Carlos', 'carlinho', 'M', '01-01-1980');
    
select * from Pessoa_Pes;
    
insert into Projeto_Prj (prj_tipo, prj_descricao, prj_iniciativa, prj_dtinicio, pes_codigo)
values
	('social','pessoas', 'público', '02-10-2010',1),
    ('educacional','crianças', 'privado', '10-03-2008',2),
    ('esportivos','Idosos', 'público', '25-12-2015',3);
    
select * from Projeto_Prj;